...
//		c = database.query(true, BLeafDbHelper.TABLE_COMPANYINFO, new String[]{BLeafDbHelper.COL_ID}, where,null,null,null,null,"1");
	...
	public Cursor getLinks(int pEid){
		...
		c = context.getContentResolver().query(Uri.withAppendedPath(CONTENT_URI, BLeafDbHelper.TABLE_LINKS), new String[]{BLeafDbHelper.COL_NAME, BLeafDbHelper.COL_LINK}, where, arg, null);
